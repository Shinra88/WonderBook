...
describe('CommentModerationModal Component', () => {
  ...
  test('should render with title', () => {
    render(<CommentModerationModal comments={mockComments} onClose={mockOnClose} onUpdate={mockOnUpdate} />)
  ...
  test('should handle comments without user info', () => {
    ...
    render(<CommentModerationModal comments={commentsWithoutUser} onClose={mockOnClose} onUpdate={mockOnUpdate} />)
