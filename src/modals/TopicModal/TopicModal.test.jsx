...
describe('TopicModal Component', () => {
  ...
  test('should enable submit button when form valid', async () => {
    ...
    await act(async () => {
      fireEvent.change(screen.getByPlaceholderText('TopicModal.Title'), { target: { value: 'Test Topic' } })
      fireEvent.change(screen.getByPlaceholderText('TopicModal.Content'), { target: { value: 'Test content' } })
