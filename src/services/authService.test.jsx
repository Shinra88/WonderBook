...
describe('authService', () => {
  ...
  describe('getCurrentUser', () => {
    ...
    it('should return null when no token', () => {
      getFromLocalStorage.mockReturnValueOnce(null).mockReturnValueOnce(JSON.stringify({ id: 1 }));
    ...
    it('should return null when no user', () => {
      getFromLocalStorage.mockReturnValueOnce('token').mockReturnValueOnce(null);
